...
CFLAGS     += -O3 \
              -Wall -Wextra -Wimplicit-function-declaration -Wno-unused-variable -Wno-unused-function -Wno-unused-but-set-variable -Wno-comment -Wno-maybe-uninitialized\
              -Wredundant-decls -Wmissing-prototypes -Wstrict-prototypes \
              -Wundef -Wshadow \
              -I$(OPENCM3DIR)/include \
              -fno-common $(ARCH_FLAGS) -MD $(DEFINES) -std=c99 -g
