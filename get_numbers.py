...
if __name__ == "__main__":
    ...
    if(sys.argv[2] == "bench_total_randomize_time"):
        ...
        if(sys.argv[1] == "Kyber512" or sys.argv[1] == "Kyber768" or sys.argv[1] == "Kyber1024"):
            print "Kyber (KeyGen & Encaps & Decaps)"
        elif(sys.argv[1] == "Dilithium2" or sys.argv[1] == "Dilithium3" or sys.argv[1] == "Dilithium4"):
            print "Dilithium (KeyGen, Sign & Verify)"
    ...
    while(total_flag == 0):
        ...
        if(sys.argv[1] == "Kyber512"):
            print kyber512_protection_list[bin_row_no][bin_col_no]
        if(sys.argv[1] == "Kyber768"):
            print kyber768_protection_list[bin_row_no][bin_col_no]
        if(sys.argv[1] == "Kyber1024"):
            print kyber1024_protection_list[bin_row_no][bin_col_no]
        elif(sys.argv[1] == "Dilithium2"):
            print dilithium2_protection_list[bin_row_no][bin_col_no]
        elif(sys.argv[1] == "Dilithium3"):
            print dilithium3_protection_list[bin_row_no][bin_col_no]
        elif(sys.argv[1] == "Dilithium4"):
            print dilithium4_protection_list[bin_row_no][bin_col_no]
